  ...
  return (
    <div>
      ...
      <div className="categories-container">
        ...
        <div className="category-container">
          <img src={vegetables} alt="image of vegetables" onClick={() => navigate("/products/fruits")}></img>
          <Link to="/products/vegetables">Vegetables</Link>
        </div>
        <div className="category-container">
          <img src={frozen} alt="image of freezers" onClick={() => navigate("/products/fruits")}></img>
          <Link to="/products/frozen">Frozen Foods</Link>
        </div>
        <div className="category-container">
          <img src={beverages} alt="image of beverages" onClick={() => navigate("/products/fruits")}></img>
          <Link to="/products/drinks">Drinks</Link>
        </div>
        <div className="category-container">
          <img src={meats} alt="image of meats" onClick={() => navigate("/products/fruits")}></img>
          <Link to="/products/meats">Meats</Link>
        </div>
        <div className="category-container">
          <img src={dairy} alt="image of dairy" onClick={() => navigate("/products/fruits")}></img>
